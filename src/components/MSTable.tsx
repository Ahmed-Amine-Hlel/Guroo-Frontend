        ...
        <div className="overflow-x-scroll lg:overflow-x-hidden table-scroll mb-[15px]">
          <div className="min-w-max lg:min-w-full">
            ...
            <div className="px-[24px] py-[17px] bg-ghostwhite-200 rounded-[16px]">
              <div className="grid grid-cols-7 gap-[8px] mb-[16px]">
              ...
              <div className="flex items-center justify-start  lg:justify-end w-full lg:px-[24px] mb-[10px]">
                <button className="flex items-center justify-center gap-[8px] h-[40px] px-[32px] rounded-[49px] border-[1px] border-foundation-purple-normal bg-gradient-to-r from-[#914FD2] from-48% to-[#946CBB] to-137% rounded-[45px] text-white hover:cursor-pointer">
