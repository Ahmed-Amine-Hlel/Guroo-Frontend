...
const Stepper = () => {
  ...
  return (
    <div className="flex flex-col items-center w-full md:w-[544px] h-auto md:h-[792px] bg-white rounded-2xl border-[0.9px] border-solid border-foundation-purple-light-hover overflow-hidden text-left text-lg text-foundation-purple-dark-active font-plus-jakarta-sans">
