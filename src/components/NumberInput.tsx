...
const NumberInput: React.FC<NumberInputProps> = ({ reducedwidth = false }) => {
    ...
    const baseClasses = `${reducedwidth ? "w-[140px]" : "w-[470px]"
    ...
    const invalidClasses =
        "ring-[4px] ring-[#f6dee8] border-[0.50px] border-solid border-[#FDA29B] bg-[#fef3f2] box-shadow-0px-0px-0px-4px-rgba(253,162,155,0.20) text-[#7A271A]"; return (
