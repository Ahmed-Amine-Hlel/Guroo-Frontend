    ...
    return (
        <div className='font-plus-jakarta-sans p-[24px] rounded-[24px] border border-gainsboro ai-card-bg w-[470px]'>
            ...
            <div className="text-[14px] text-light-gray">
                Basé sur les informations communiquées à la question Quelle
                surface est votre restaurant ? Nous vous conseillons d’avoir un
                nombre <span className="text-white">de couverts compris en 35 et 50 maximum.</span>
            </div>
        </div>
    )
}
