...
const LoungeComponent3 = ({
  ...
  const isPetitDéjeunerSelected =
    localStorage.getItem("lounge-Petit-déjeuner") === "true";

  const isDéjeunerSelected = localStorage.getItem("lounge-Déjeuner") === "true";

  const isDinerSelected = localStorage.getItem("lounge-Diner") === "true";

  const isBrasserieMatinSelected =
    localStorage.getItem("lounge-Brasserie Matin") === "true";

  const isBrasserieApresMidiSelected =
    localStorage.getItem("lounge-Brasserie après midi") === "true";
      ...
      <div className="overflow-y-scroll py-[5px] overflow-x-hidden px-2 qb-thumb h-[500px] mb-[24px]">
        ...
        {isPetitDéjeunerSelected && (
          <div className="w-full sm:px-[35spx] mb-[24px]">
            ...
            <InputAmount
              value={answers["196"] ?? 0}
              onChange={(value) => handleInputChange("196", value.toString())}
            />
        ...
        {isDéjeunerSelected && (
          <div className="w-full sm:px-[35spx] mb-[24px]">
            ...
            <InputAmount
              value={answers["198"] ?? 0}
              onChange={(value) => handleInputChange("198", value.toString())}
            />
            <div className="px-[16px] mt-[8px] text-[#41245E] opacity-50 text-[14px]">
              Le ticket moyen correspond à la somme moyenne dépensée par client
              au sein de votre lounge.
        ...
        {isDinerSelected && (
          <div className="w-full sm:px-[35spx] mb-[24px]">
            ...
            <InputAmount
              value={answers["200"] ?? 0}
              onChange={(value) => handleInputChange("200", value.toString())}
            />
            <div className="px-[16px] mt-[8px] text-[#41245E] opacity-50 text-[14px]">
              Le ticket moyen correspond à la somme moyenne dépensée par client
              au sein de votre lounge.
        ...
        {isBrasserieMatinSelected && (
          <div className="w-full sm:px-[35spx] mb-[24px]">
            ...
            <InputAmount
              value={answers["197"] ?? 0}
              onChange={(value) => handleInputChange("197", value.toString())}
            />
            <div className="px-[16px] mt-[8px] text-[#41245E] opacity-50 text-[14px]">
              Le ticket moyen correspond à la somme moyenne dépensée par client
              au sein de votre lounge.
        ...
        {isBrasserieApresMidiSelected && (
          <div className="w-full sm:px-[35spx] mb-[24px]">
            ...
            <InputAmount
              value={answers["199"] ?? 0}
              onChange={(value) => handleInputChange("199", value.toString())}
            />
            <div className="px-[16px] mt-[8px] text-[#41245E] opacity-50 text-[14px]">
              Le ticket moyen correspond à la somme moyenne dépensée par client
              au sein de votre lounge.
...
export default LoungeComponent3;
