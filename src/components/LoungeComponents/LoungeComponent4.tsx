      ...
      <div className="overflow-y-scroll py-[5px] overflow-x-hidden px-2 qb-thumb h-[500px] mb-[24px]">
        ...
        {isPetitDéjeunerSelected && (
          <div className="w-full sm:px-[35spx] mb-[24px]">
            ...
            <NumberInput
              value={answers['202'] ?? 0}
              onChange={(value) => handleInputChange('202', value)}
            ...
            <div className="px-[16px] mt-[8px] text-[#41245E] opacity-50 text-[14px]">
              ...
              pensez accueillir une fois votre lounge à son plein potentiel
            </div>
          </div>
        )}
        ...
        {isDéjeunerSelected && (
          <div className="w-full sm:px-[35spx] mb-[24px]">
            ...
            <NumberInput
              value={answers['204'] ?? 0}
              onChange={(value) => handleInputChange('204', value)}
              validation={'max:|min:0'}
            />
            <div className="px-[16px] mt-[8px] text-[#41245E] opacity-50 text-[14px]">
              Le nombre de couvert correspond au nombre de personnes que vous
        ...
        {isDinerSelected && (
          <div className="w-full sm:px-[35spx] mb-[24px]">
            ...
            <NumberInput
              ...
              value={answers['206'] ?? 0}
              onChange={(value) => handleInputChange('206', value)}
              validation={'max:|min:0'}
            />
            <div className="px-[16px] mt-[8px] text-[#41245E] opacity-50 text-[14px]">
              Le nombre de couvert correspond au nombre de personnes que vous
        ...
        {isBrasserieMatinSelected && (
          <div className="w-full sm:px-[35spx] mb-[24px]">
            ...
            <NumberInput
              value={answers['203'] ?? 0}
              onChange={(value) => handleInputChange('203', value)}
              validation={'max:|min:0'}
            />
            <div className="px-[16px] mt-[8px] text-[#41245E] opacity-50 text-[14px]">
              Le nombre de couvert correspond au nombre de personnes que vous
        ...
        {isBrasserieApresMidiSelected && (
          <div className="w-full sm:px-[35spx] mb-[24px]">
            ...
            <NumberInput
              value={answers['205'] ?? 0}
              onChange={(value) => handleInputChange('205', value)}
              validation={'max:|min:0'}
            />
            <div className="px-[16px] mt-[8px] text-[#41245E] opacity-50 text-[14px]">
              Le nombre de couvert correspond au nombre de personnes que vous
...
export default LoungeComponent4;
