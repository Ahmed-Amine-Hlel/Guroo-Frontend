...
const ChatBot = () => {
  ...
  return (
    <div
      ref={chatBotRef}
      className={`z-50 fixed right-8 bottom-10 w-[350px] font-plus-jakarta-sans ${
        !isOpened ? "h-max" : "h-[600px] "
      }`}
    >
      <div className="z-50 relative h-full">
        ...
        {isOpened && (
          <div
            className={`absolute bottom-0 right-6 w-full h-full bg-transparent pb-[50px] min-[1864px]:pb-[60px] transition-transform duration-300 ${
              isOpened ? "ping-enter" : ""
            }`}
          >
