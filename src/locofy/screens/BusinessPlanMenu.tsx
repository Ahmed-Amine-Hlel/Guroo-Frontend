            ...
            <div className="flex flex-col w-full">
              ...
              {loading ? ".." : user?.givenName}
                ...
                <div className="flex items-center justify-end gap-[10px] h-[75px] rounded-[16px] px-[18px] py-[22px] mb-[22px]">
                    ...
                    <div
                        className={`cursor-pointer flex justify-center items-center bg-white w-10 h-10 rounded-[4px] ${displayType === 'grid' ? 'opacity-70' : ''}`}
                        onClick={() => displayType !== 'grid' && handleChangeDisplayType('grid')}
                    >
                        <BsGrid
                            size={26}
                    ...
                    <div
                        className={`cursor-pointer flex justify-center items-center bg-white w-10 h-10 rounded-[4px] ${displayType !== 'grid' ? 'opacity-70' : ''}`}
                        onClick={() => displayType !== 'flex-box' && handleChangeDisplayType('flex-box')}
                    >
                        <PiListBulletsBold
                            size={28}
                            color="rgba(131, 71, 189, 1)"
                    ...
                    {businessPlan?.length === 0 ? (
                        ...
                        <div
                            ...
                            {businessPlan?.map((plan) => (
                                ...
                                >
                                    <div className={displayType === 'grid' ? '' : 'flex items-center'}>
                                        <div>
                                            <div
                                        ...
                                        <div className="flex justify-between items-center w-full text-[#5C3C7C]">
                                            <div className="text-[20px]">{plan.title}</div>
                                            <div
                                                className={`ms-auto relative flex gap-1.5 items-center ${displayType === 'grid' ? 'flex-col ' : ''}`}>
                                                <AiOutlineDelete
                                                    size={20}
                                                    color="#c5b1d8"
