...
const PrePayementScreen = () => {
  ...
  const handleChanges = (e: ChangeEvent<HTMLSelectElement>) => {
    ...
    const country: CountryCode | undefined = countries.find(
      (country: CountryCode) => country.dial_code === value
    );
    setCountry(country);
  };
      ...
      <div className="w-[380px] md:w-[626px] flex flex-col gap-[42px] items-center form-shadow px-[10px] md:px-[60px] py-[25px] md:py-[55px] rounded-[24px] bg-white">
        ...
        <div className="flex flex-col justify-center gap-[22px]">
          <div className="flex flex-col gap-[6px]">
            <label htmlFor="full-name" className="text-gray-700 text-[14px]">
              Nom entier*
            </label>
            <input
              name="full-name"
          ...
          <div className="flex flex-col justify-center gap-[6px]">
            <label htmlFor="email" className="text-gray-700 text-[14px]">
              Email*
            </label>
            <input
              name="email"
          ...
          <div className="flex flex-col gap-[6px]">
            <label htmlFor="tel" className="text-gray-700 text-[14px]">
              Numéro de téléphone
            </label>
              ...
              <div className="flex justify-center items-center overflow-hidden h-[30px] w-[30px] mr-1 rounded-full">
                <img
                  src={`https://hatscripts.github.io/circle-flags/flags/${
                    country?.code ? country?.code.toLowerCase() : "fr"
                  }.svg`}
                  alt="flag"
